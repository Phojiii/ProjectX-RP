...
export default function LSPDForm() {
  ...
  return (
    <div className="bg-[url(/lspd-bg.jpg)] bg-no-repeat bg-center bg-cover">
      {/* <Navbar /> */}
      <div className="bg-slate-800 bg-opacity-50">
        <form onSubmit={handleSubmit} className="p-4 max-w-4xl mx-auto text-white">
          ...
          <label>Enter Your Discord ID:</label>
          <input
            type="text"
            value={discordId}
          ...
          <label>Enter Your Stream HEX:</label>
          <input
            type="text"
            value={hex}
          ...
          <label>How many hours you have on Project X RP?</label>
          <input
            type="text"
            value={hoursPlayed}
          ...
          <label>Previous Experience in the LSPD?</label>
          <textarea
          ...
          <label>Brief description about yourself (Min 50 words)</label>
          <textarea
            value={aboutYou}
          ...
          <label>Why do you want to become an officer? (Min 100 words)</label>
          <textarea
            value={whyOfficer}
          ...
          <label>Character Backstory (Min 150 Words)</label>
          <textarea
            value={backstory}
